                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b>Contact</b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div id="" class="muted"><span class="muted pull-left">MANAGE CONTACTS </span></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="icon-info"></i> CONTACTS MANAGEMENT PAGE </div>
								<?php
								$query = mysqli_query($dbhandle,"select * from contact where user_id = '$session_id'");
