...
$uploaded_by_query = mysqli_query($dbhandle,"select * from tbluser where user_id = '$session_id'");
$uploaded_by_query_row = mysqli_fetch_assoc($uploaded_by_query);
...
function clean($str, $dbhandles) {
    $str = @trim($str);
    if (get_magic_quotes_gpc()) {
        $str = stripslashes($str);
    }
    return mysqli_real_escape_string($dbhandles,$str);
}

//Sanitize the POST values
$filedesc = clean($_POST['desc'], $dbhandle);
