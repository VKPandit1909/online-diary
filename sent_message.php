                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<div id="" class="muted"><span class="muted pull-left">ALL SENT MESSAGES IN RECORDS </span></div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="#" method="post">
										...
										<li class=""><a href="message.php"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class="active"><a href="sent_message.php"><i class="icon-envelope-alt"></i>Sent messages</a></li>
										</ul>
									
									<?php
								 $query_announcement = mysqli_query($dbhandle,"select * from message
																	LEFT JOIN tbluser ON tbluser.user_id = message.reciever_id
																	where  message.sender_id = '$session_id' order by date_sended DESC
																	");
								...
								if ($count_my_message != '0'){
								 ...
								 ?>
											...
											<?php } ?>
													...
													<hr>
											Send to: <strong><?php echo $row['firstname']." ".$row['lastname']; ?></strong>
